...
def handle_jury_emergency_alert(body):
    ...
    try:
        ...
        emergency_phone = body.get('phoneNumber', '<REDACTED_PHONE_NUMBER>')
        ...
        return cors_response({
            ...
            'emergencyPhone': body.get('phoneNumber', '<REDACTED_PHONE_NUMBER>'),
...
def handle_jury_test(body):
    ...
    """
    try:
        test_phone = body.get('phoneNumber', '<REDACTED_PHONE_NUMBER>')
