...
try {
    $response = Invoke-RestMethod -Uri $lambdaUrl -Method POST -Body '{"action":"MAKE_REAL_CALL","phoneNumber":"+13053033060","emergencyMessage":"Final test"}' -ContentType "application/json"
