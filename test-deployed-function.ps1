...
Write-Host "`nTest 5: Direct SMS to Jury Phone (+13053033060)" -ForegroundColor Yellow
try {
    $response = Invoke-RestMethod -Uri $lambdaUrl -Method POST -Body '{"action":"MAKE_REAL_CALL","phoneNumber":"+13053033060","emergencyMessage":"Deployment test successful!"}' -ContentType "application/json"
